    ...
    <div class="right mx-lg-0 mx-auto">
      ...
      <form style="margin-top: 1.5rem" action="{{ route('register') }}" method="POST">
        ...
        <div style="margin-bottom: 1rem">
          <label for="name" class="d-block input-label">Username</label>
        ...
        <div style="margin-top: 1rem">
          <label for="email" class="d-block input-label">Email Address</label>
          <div class="d-flex w-100 div-input">
            <svg class="icon" style="margin-right: 1rem" width="24" height="24" viewBox="0 0 24 24" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div style="margin-top: 1rem">
          <label for="password-confirm" class="d-block input-label">Confirm Password</label>
          <div class="d-flex w-100 div-input">
            <svg class="icon" style="margin-right: 1rem" width="24" height="24" viewBox="0 0 24 24" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd"
